...
public class Test__Scenario1_1_2 implements Experiment {
    ...
    private static final Fault[] NEGATIVE_FAULTS = {
            new Fault("-fault-01", 2 /*t=0*/, (input) -> Value5.I.equals(input[V1]) && Value5.II.equals(input[V2])),
            new Fault("-fault-02", 2 /*t=0*/, (input) -> Value5.I.equals(input[V2]) && Value5.II.equals(input[V3])),
            new Fault("-fault-03", 2 /*t=0*/, (input) -> Value5.I.equals(input[V3]) && Value5.II.equals(input[V4])),
            new Fault("-fault-04", 2 /*t=0*/, (input) -> Value5.I.equals(input[V4]) && Value5.II.equals(input[V5])),
            new Fault("-fault-05", 2 /*t=0*/, (input) -> Value5.I.equals(input[V5]) && Value5.II.equals(input[V1])),

            new Fault("-fault-06", 3 /*t=1*/, (input) -> Config2.A.equals(input[X5]) && (Value5.I.equals(input[V1]) && Value5.II.equals(input[V2]))),
            new Fault("-fault-07", 3 /*t=1*/, (input) -> Config2.B.equals(input[X3]) && (Value5.I.equals(input[V2]) && Value5.II.equals(input[V3]))),
            new Fault("-fault-08", 3 /*t=1*/, (input) -> Config2.B.equals(input[X4]) && (Value5.I.equals(input[V3]) && Value5.II.equals(input[V4]))),
            new Fault("-fault-09", 3 /*t=1*/, (input) -> Config2.A.equals(input[X2]) && (Value5.I.equals(input[V4]) && Value5.II.equals(input[V5]))),
            new Fault("-fault-10", 3 /*t=1*/, (input) -> Config2.A.equals(input[X1]) && (Value5.I.equals(input[V5]) && Value5.II.equals(input[V1]))),

            new Fault("-fault-11", 4 /*t=2*/, (input) -> Config2.A.equals(input[X4]) && Config2.B.equals(input[X3]) && (Value5.I.equals(input[V1]) && Value5.II.equals(input[V2]))),
            new Fault("-fault-12", 4 /*t=2*/, (input) -> Config2.A.equals(input[X3]) && Config2.B.equals(input[X2]) && (Value5.I.equals(input[V2]) && Value5.II.equals(input[V3]))),
            new Fault("-fault-13", 4 /*t=2*/, (input) -> Config2.A.equals(input[X2]) && Config2.B.equals(input[X1]) && (Value5.I.equals(input[V3]) && Value5.II.equals(input[V4]))),
            new Fault("-fault-14", 4 /*t=2*/, (input) -> Config2.A.equals(input[X1]) && Config2.B.equals(input[X5]) && (Value5.I.equals(input[V4]) && Value5.II.equals(input[V5]))),
            new Fault("-fault-15", 4 /*t=2*/, (input) -> Config2.A.equals(input[X5]) && Config2.B.equals(input[X4]) && (Value5.I.equals(input[V5]) && Value5.II.equals(input[V1]))),

            new Fault("-fault-16", 5 /*t=3*/, (input) -> Config2.B.equals(input[X2]) && Config2.B.equals(input[X3]) && Config2.B.equals(input[X5]) && (Value5.I.equals(input[V1]) && Value5.II.equals(input[V2]))),
            new Fault("-fault-17", 5 /*t=3*/, (input) -> Config2.B.equals(input[X1]) && Config2.B.equals(input[X3]) && Config2.A.equals(input[X4]) && (Value5.I.equals(input[V2]) && Value5.II.equals(input[V3]))),
            new Fault("-fault-18", 5 /*t=3*/, (input) -> Config2.A.equals(input[X3]) && Config2.A.equals(input[X4]) && Config2.A.equals(input[X5]) && (Value5.I.equals(input[V3]) && Value5.II.equals(input[V4]))),
            new Fault("-fault-19", 5 /*t=3*/, (input) -> Config2.A.equals(input[X2]) && Config2.B.equals(input[X4]) && Config2.A.equals(input[X5]) && (Value5.I.equals(input[V4]) && Value5.II.equals(input[V5]))),
            new Fault("-fault-20", 5 /*t=3*/, (input) -> Config2.A.equals(input[X1]) && Config2.B.equals(input[X2]) && Config2.A.equals(input[X3]) && (Value5.I.equals(input[V5]) && Value5.II.equals(input[V1]))),
    };
    ...
    public ExecutionInformation executeTestMethod(Object[] input) {
        ...
        if(Value5.I.equals(input[V1]) && Value5.II.equals(input[V2])) {
        ...
        } else if(Value5.I.equals(input[V2]) && Value5.II.equals(input[V3])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value5.I.equals(input[V3]) && Value5.II.equals(input[V4])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value5.I.equals(input[V4]) && Value5.II.equals(input[V5])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value5.I.equals(input[V5]) && Value5.II.equals(input[V1])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
    ...
    public Constraint[] getErrorConstraints() {
        return new Constraint[] {
                constrain("v1", "v2").by((Value5 v1, Value5 v2) -> !(Value5.I.equals(v1) && Value5.II.equals(v2))),
                constrain("v2", "v3").by((Value5 v2, Value5 v3) -> !(Value5.I.equals(v2) && Value5.II.equals(v3))),
                constrain("v3", "v4").by((Value5 v3, Value5 v4) -> !(Value5.I.equals(v3) && Value5.II.equals(v4))),
                constrain("v4", "v5").by((Value5 v4, Value5 v5) -> !(Value5.I.equals(v4) && Value5.II.equals(v5))),
                constrain("v5", "v1").by((Value5 v5, Value5 v1) -> !(Value5.I.equals(v5) && Value5.II.equals(v1)))
        };
    }
