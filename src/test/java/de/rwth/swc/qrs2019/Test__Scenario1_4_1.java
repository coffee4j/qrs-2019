...
public class Test__Scenario1_4_1 implements Experiment {
    ...
    private static final Fault[] NEGATIVE_FAULTS = {
            new Fault("-fault-01", 1 /*t=0*/, (input) -> Value7.I.equals(input[V1])),
            new Fault("-fault-02", 1 /*t=0*/, (input) -> Value7.I.equals(input[V2])),
            new Fault("-fault-03", 1 /*t=0*/, (input) -> Value7.I.equals(input[V3])),
            new Fault("-fault-04", 1 /*t=0*/, (input) -> Value7.I.equals(input[V4])),
            new Fault("-fault-05", 1 /*t=0*/, (input) -> Value7.I.equals(input[V5])),

            new Fault("-fault-06", 2 /*t=1*/, (input) -> Config3.A.equals(input[X5]) && (Value7.I.equals(input[V1]))),
            new Fault("-fault-07", 2 /*t=1*/, (input) -> Config3.B.equals(input[X3]) && (Value7.I.equals(input[V2]))),
            new Fault("-fault-08", 2 /*t=1*/, (input) -> Config3.B.equals(input[X4]) && (Value7.I.equals(input[V3]))),
            new Fault("-fault-09", 2 /*t=1*/, (input) -> Config3.A.equals(input[X2]) && (Value7.I.equals(input[V4]))),
            new Fault("-fault-10", 2 /*t=1*/, (input) -> Config3.A.equals(input[X1]) && (Value7.I.equals(input[V5]))),

            new Fault("-fault-11", 3 /*t=2*/, (input) -> Config3.A.equals(input[X4]) && Config3.B.equals(input[X3]) && (Value7.I.equals(input[V1]))),
            new Fault("-fault-12", 3 /*t=2*/, (input) -> Config3.A.equals(input[X3]) && Config3.B.equals(input[X2]) && (Value7.I.equals(input[V2]))),
            new Fault("-fault-13", 3 /*t=2*/, (input) -> Config3.A.equals(input[X2]) && Config3.B.equals(input[X1]) && (Value7.I.equals(input[V3]))),
            new Fault("-fault-14", 3 /*t=2*/, (input) -> Config3.A.equals(input[X1]) && Config3.B.equals(input[X5]) && (Value7.I.equals(input[V4]))),
            new Fault("-fault-15", 3 /*t=2*/, (input) -> Config3.A.equals(input[X5]) && Config3.B.equals(input[X4]) && (Value7.I.equals(input[V5]))),

            new Fault("-fault-16", 4 /*t=3*/, (input) -> Config3.B.equals(input[X2]) && Config3.B.equals(input[X3]) && Config3.B.equals(input[X5]) && (Value7.I.equals(input[V1]))),
            new Fault("-fault-17", 4 /*t=3*/, (input) -> Config3.B.equals(input[X1]) && Config3.B.equals(input[X3]) && Config3.A.equals(input[X4]) && (Value7.I.equals(input[V2]))),
            new Fault("-fault-18", 4 /*t=3*/, (input) -> Config3.A.equals(input[X3]) && Config3.A.equals(input[X4]) && Config3.A.equals(input[X5]) && (Value7.I.equals(input[V3]))),
            new Fault("-fault-19", 4 /*t=3*/, (input) -> Config3.A.equals(input[X2]) && Config3.B.equals(input[X4]) && Config3.A.equals(input[X5]) && (Value7.I.equals(input[V4]))),
            new Fault("-fault-20", 4 /*t=3*/, (input) -> Config3.A.equals(input[X1]) && Config3.B.equals(input[X2]) && Config3.A.equals(input[X3]) && (Value7.I.equals(input[V5]))),
    };
    ...
    public ExecutionInformation executeTestMethod(Object[] input) {
        ...
        } else if(Value7.I.equals(input[V2])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value7.I.equals(input[V3])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value7.I.equals(input[V4])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value7.I.equals(input[V5])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
    ...
    public Constraint[] getErrorConstraints() {
        return new Constraint[] {
                constrain("v1").by((Value7 v1) -> !Value7.I.equals(v1)),
                constrain("v2").by((Value7 v2) -> !Value7.I.equals(v2)),
                constrain("v3").by((Value7 v3) -> !Value7.I.equals(v3)),
                constrain("v4").by((Value7 v4) -> !Value7.I.equals(v4)),
                constrain("v5").by((Value7 v5) -> !Value7.I.equals(v5))
        };
    }
