...
public class Test__Scenario1_4_3 implements Experiment {
    ...
    private static final Fault[] NEGATIVE_FAULTS = {
            new Fault("-fault-01", 3 /*t=0*/, (input) -> Value7.I.equals(input[V1]) && Value7.II.equals(input[V2]) && Value7.III.equals(input[V3])),
            new Fault("-fault-02", 3 /*t=0*/, (input) -> Value7.I.equals(input[V2]) && Value7.II.equals(input[V3]) && Value7.III.equals(input[V4])),
            new Fault("-fault-03", 3 /*t=0*/, (input) -> Value7.I.equals(input[V3]) && Value7.II.equals(input[V4]) && Value7.III.equals(input[V5])),
            new Fault("-fault-04", 3 /*t=0*/, (input) -> Value7.I.equals(input[V4]) && Value7.II.equals(input[V5]) && Value7.III.equals(input[V1])),
            new Fault("-fault-05", 3 /*t=0*/, (input) -> Value7.I.equals(input[V5]) && Value7.II.equals(input[V1]) && Value7.III.equals(input[V2])),

            new Fault("-fault-06", 4 /*t=1*/, (input) -> Config3.A.equals(input[X5]) && (Value7.I.equals(input[V1]) && Value7.II.equals(input[V2]) && Value7.III.equals(input[V3]))),
            new Fault("-fault-07", 4 /*t=1*/, (input) -> Config3.B.equals(input[X3]) && (Value7.I.equals(input[V2]) && Value7.II.equals(input[V3]) && Value7.III.equals(input[V4]))),
            new Fault("-fault-08", 4 /*t=1*/, (input) -> Config3.B.equals(input[X4]) && (Value7.I.equals(input[V3]) && Value7.II.equals(input[V4]) && Value7.III.equals(input[V5]))),
            new Fault("-fault-09", 4 /*t=1*/, (input) -> Config3.A.equals(input[X2]) && (Value7.I.equals(input[V4]) && Value7.II.equals(input[V5]) && Value7.III.equals(input[V1]))),
            new Fault("-fault-10", 4 /*t=1*/, (input) -> Config3.A.equals(input[X1]) && (Value7.I.equals(input[V5]) && Value7.II.equals(input[V1]) && Value7.III.equals(input[V2]))),

            new Fault("-fault-11", 5 /*t=2*/, (input) -> Config3.A.equals(input[X4]) && Config3.B.equals(input[X3]) && (Value7.I.equals(input[V1]) && Value7.II.equals(input[V2]) && Value7.III.equals(input[V3]))),
            new Fault("-fault-12", 5 /*t=2*/, (input) -> Config3.A.equals(input[X3]) && Config3.B.equals(input[X2]) && (Value7.I.equals(input[V2]) && Value7.II.equals(input[V3]) && Value7.III.equals(input[V4]))),
            new Fault("-fault-13", 5 /*t=2*/, (input) -> Config3.A.equals(input[X2]) && Config3.B.equals(input[X1]) && (Value7.I.equals(input[V3]) && Value7.II.equals(input[V4]) && Value7.III.equals(input[V5]))),
            new Fault("-fault-14", 5 /*t=2*/, (input) -> Config3.A.equals(input[X1]) && Config3.B.equals(input[X5]) && (Value7.I.equals(input[V4]) && Value7.II.equals(input[V5]) && Value7.III.equals(input[V1]))),
            new Fault("-fault-15", 5 /*t=2*/, (input) -> Config3.A.equals(input[X5]) && Config3.B.equals(input[X4]) && (Value7.I.equals(input[V5]) && Value7.II.equals(input[V1]) && Value7.III.equals(input[V2]))),

            new Fault("-fault-16", 6 /*t=3*/, (input) -> Config3.B.equals(input[X2]) && Config3.B.equals(input[X3]) && Config3.B.equals(input[X5]) && (Value7.I.equals(input[V1]) && Value7.II.equals(input[V2])) && Value7.III.equals(input[V3])),
            new Fault("-fault-17", 6 /*t=3*/, (input) -> Config3.B.equals(input[X1]) && Config3.B.equals(input[X3]) && Config3.A.equals(input[X4]) && (Value7.I.equals(input[V2]) && Value7.II.equals(input[V3])) && Value7.III.equals(input[V4])),
            new Fault("-fault-18", 6 /*t=3*/, (input) -> Config3.A.equals(input[X3]) && Config3.A.equals(input[X4]) && Config3.A.equals(input[X5]) && (Value7.I.equals(input[V3]) && Value7.II.equals(input[V4])) && Value7.III.equals(input[V5])),
            new Fault("-fault-19", 6 /*t=3*/, (input) -> Config3.A.equals(input[X2]) && Config3.B.equals(input[X4]) && Config3.A.equals(input[X5]) && (Value7.I.equals(input[V4]) && Value7.II.equals(input[V5])) && Value7.III.equals(input[V1])),
            new Fault("-fault-20", 6 /*t=3*/, (input) -> Config3.A.equals(input[X1]) && Config3.B.equals(input[X2]) && Config3.A.equals(input[X3]) && (Value7.I.equals(input[V5]) && Value7.II.equals(input[V1])) && Value7.III.equals(input[V2])),
    };
    ...
    public ExecutionInformation executeTestMethod(Object[] input) {
        ...
        if(Value7.I.equals(input[V1]) && Value7.II.equals(input[V2]) && Value7.III.equals(input[V3])) {
        ...
        } else if(Value7.I.equals(input[V2]) && Value7.II.equals(input[V3]) && Value7.III.equals(input[V4])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value7.I.equals(input[V3]) && Value7.II.equals(input[V4]) && Value7.III.equals(input[V5])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value7.I.equals(input[V4]) && Value7.II.equals(input[V5]) && Value7.III.equals(input[V1])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value7.I.equals(input[V5]) && Value7.II.equals(input[V1]) && Value7.III.equals(input[V2])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
    ...
    public Constraint[] getErrorConstraints() {
        return new Constraint[] {
                constrain("v1", "v2", "v3").by((Value7 v1, Value7 v2, Value7 v3) -> !(Value7.I.equals(v1) && Value7.II.equals(v2) && Value7.III.equals(v3))),
                constrain("v2", "v3", "v4").by((Value7 v2, Value7 v3, Value7 v4) -> !(Value7.I.equals(v2) && Value7.II.equals(v3) && Value7.III.equals(v4))),
                constrain("v3", "v4", "v5").by((Value7 v3, Value7 v4, Value7 v5) -> !(Value7.I.equals(v3) && Value7.II.equals(v4) && Value7.III.equals(v5))),
                constrain("v4", "v5", "v1").by((Value7 v4, Value7 v5, Value7 v1) -> !(Value7.I.equals(v4) && Value7.II.equals(v5) && Value7.III.equals(v1))),
                constrain("v5", "v1", "v2").by((Value7 v5, Value7 v1, Value7 v2) -> !(Value7.I.equals(v5) && Value7.II.equals(v1) && Value7.III.equals(v2)))
        };
    }

    @Test
    void testEffectiveness() {
        computeEffectiveness(this, new Scenario1_4());
    }
}