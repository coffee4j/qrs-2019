...
public class Test__Scenario1_1_1 implements Experiment {
    ...
    private static final Fault[] NEGATIVE_FAULTS = {
            new Fault("-fault-01", 1 /*t=0*/, (input) -> Value5.I.equals(input[V1])),
            new Fault("-fault-02", 1 /*t=0*/, (input) -> Value5.I.equals(input[V2])),
            new Fault("-fault-03", 1 /*t=0*/, (input) -> Value5.I.equals(input[V3])),
            new Fault("-fault-04", 1 /*t=0*/, (input) -> Value5.I.equals(input[V4])),
            new Fault("-fault-05", 1 /*t=0*/, (input) -> Value5.I.equals(input[V5])),

            new Fault("-fault-06", 2 /*t=1*/, (input) -> Config2.A.equals(input[X5]) && (Value5.I.equals(input[V1]))),
            new Fault("-fault-07", 2 /*t=1*/, (input) -> Config2.B.equals(input[X3]) && (Value5.I.equals(input[V2]))),
            new Fault("-fault-08", 2 /*t=1*/, (input) -> Config2.B.equals(input[X4]) && (Value5.I.equals(input[V3]))),
            new Fault("-fault-09", 2 /*t=1*/, (input) -> Config2.A.equals(input[X2]) && (Value5.I.equals(input[V4]))),
            new Fault("-fault-10", 2 /*t=1*/, (input) -> Config2.A.equals(input[X1]) && (Value5.I.equals(input[V5]))),

            new Fault("-fault-11", 3 /*t=2*/, (input) -> Config2.A.equals(input[X4]) && Config2.B.equals(input[X3]) && (Value5.I.equals(input[V1]))),
            new Fault("-fault-12", 3 /*t=2*/, (input) -> Config2.A.equals(input[X3]) && Config2.B.equals(input[X2]) && (Value5.I.equals(input[V2]))),
            new Fault("-fault-13", 3 /*t=2*/, (input) -> Config2.A.equals(input[X2]) && Config2.B.equals(input[X1]) && (Value5.I.equals(input[V3]))),
            new Fault("-fault-14", 3 /*t=2*/, (input) -> Config2.A.equals(input[X1]) && Config2.B.equals(input[X5]) && (Value5.I.equals(input[V4]))),
            new Fault("-fault-15", 3 /*t=2*/, (input) -> Config2.A.equals(input[X5]) && Config2.B.equals(input[X4]) && (Value5.I.equals(input[V5]))),

            new Fault("-fault-16", 4 /*t=3*/, (input) -> Config2.B.equals(input[X2]) && Config2.B.equals(input[X3]) && Config2.B.equals(input[X5]) && (Value5.I.equals(input[V1]))),
            new Fault("-fault-17", 4 /*t=3*/, (input) -> Config2.B.equals(input[X1]) && Config2.B.equals(input[X3]) && Config2.A.equals(input[X4]) && (Value5.I.equals(input[V2]))),
            new Fault("-fault-18", 4 /*t=3*/, (input) -> Config2.A.equals(input[X3]) && Config2.A.equals(input[X4]) && Config2.A.equals(input[X5]) && (Value5.I.equals(input[V3]))),
            new Fault("-fault-19", 4 /*t=3*/, (input) -> Config2.A.equals(input[X2]) && Config2.B.equals(input[X4]) && Config2.A.equals(input[X5]) && (Value5.I.equals(input[V4]))),
            new Fault("-fault-20", 4 /*t=3*/, (input) -> Config2.A.equals(input[X1]) && Config2.B.equals(input[X2]) && Config2.A.equals(input[X3]) && (Value5.I.equals(input[V5]))),
    };
    ...
    public ExecutionInformation executeTestMethod(Object[] input) {
        ...
        } else if(Value5.I.equals(input[V2])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value5.I.equals(input[V3])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value5.I.equals(input[V4])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
        ...
        } else if(Value5.I.equals(input[V5])) {
            information.setProgramPath(ProgramPath.NEGATIVE);
    ...
    public Constraint[] getErrorConstraints() {
        return new Constraint[] {
                constrain("v1").by((Value5 v1) -> !Value5.I.equals(v1)),
                constrain("v2").by((Value5 v2) -> !Value5.I.equals(v2)),
                constrain("v3").by((Value5 v3) -> !Value5.I.equals(v3)),
                constrain("v4").by((Value5 v4) -> !Value5.I.equals(v4)),
                constrain("v5").by((Value5 v5) -> !Value5.I.equals(v5))
        };
    }
